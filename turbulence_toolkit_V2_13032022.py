...
from giverny.turbulence_gizmos.getVelocityatPoint_V2_13032022 import *
from giverny.turbulence_gizmos.getVelocity_bigbox_V2_13032022 import *
...
#    print(node_x,node_y,node_z)
    ...
    x_range = [int(node_x-3), int(node_x+4)]
    y_range = [int(node_y-3), int(node_y+4)]
    z_range = [int(node_z-3), int(node_z+4)]
...
def getVelocity_V2(points,npoints,dn_x, dx, cube,
    ...
    x_range = [int(min_node_x-3), int(max_node_x+4)]
    y_range = [int(min_node_y-3), int(max_node_y+4)]
    z_range = [int(min_node_z-3), int(max_node_z+4)]
