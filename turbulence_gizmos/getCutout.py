...
#     print(Fore.RED + 'Step one, user_single_db_boxes')
#     print(Fore.BLACK + '')
#     print(user_single_db_boxes)
...
#         print(Fore.RED + 'db_file in sorted(user_single_db_boxes, key = lambda x: os.path.basename(x))')
#         print(Fore.BLACK + '')
#         print(db_file)
...
#         print(Fore.RED + 'database_file_disk = db_file.split(os.sep)')
#         print(Fore.BLACK + '')
#         print(database_file_disk)
...
#         print(Fore.RED + 'database_file_disks.add(database_file_disk)')
#         print(Fore.BLACK + '')
#         print(database_file_disks)
...
#             print(Fore.RED + 'user_db_box_minLim')
#             print(Fore.BLACK + '')
#             print(user_db_box_minLim)
            
#             print(Fore.RED + 'user_db_box_key')
#             print(Fore.BLACK + '')
#             print(user_db_box_key)
...
#             print(Fore.RED + 'sub_db_boxes[database_file_disk][db_file][user_db_box_key] = morton_voxels_to_read')
#             print(Fore.BLACK + '')
#             print(sub_db_boxes)
